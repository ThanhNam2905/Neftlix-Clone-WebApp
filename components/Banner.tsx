    ...
    return (
        <div className="flex flex-col space-y-3 h-[95vh] justify-center md:space-y-4 lg:space-y-6">
            ...
            <div className="flex items-center space-x-3 md:space-x-4 lg:space-x-6">
                <button className="btn"><FaPlay className="w-4 h-4 md:w-5 md:h-5"/>Play</button>
                <button className="btn bg-white text-black"><FaInfoCircle className="w-4 h-4 md:w-5 md:h-5"/>More Info</button>
            </div>
        </div>
    )
}
